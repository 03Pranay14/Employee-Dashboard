...
def contact(request):
    if request.method=="POST":
        ...
        messages.success(request,'Response recorded successfully We will contact You shortly')
...
def insertData(request):
    ...
    if request.method == 'POST':
        ...
        # print(name,email,role,gender)
        query = Employee(name=name,email=email,role=role,gender=gender)
        query.save()
